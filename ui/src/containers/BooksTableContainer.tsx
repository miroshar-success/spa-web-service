...
import { loadBooks, searchBook, removeBook, addBook, editBook } from '@redux/books/actions';
import {
  getData,
  getPagination,
  getLoadingStatus,
...
export default connect(mapStateToProps, { loadBooks, searchBook, removeBook, addBook, editBook })(FilterableBooksTable);